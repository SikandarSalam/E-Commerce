...
<body class="hold-transition login-page sidebar-mini" style="background-image: url(11.jpg); background-size:cover;">

<div class="login-box" style="background-color:lightgray; padding:10px; border-radius:5px;">
